    ...
    fun getVersionsList(): List<Android> {
        return listOf(
            ...
            Android(
                ...
                R.drawable.poster,
                "Android 12 delivers even more personal, safe and effortless experiences on your device. Featuring a " +
                        "totally reimagined UI just for you, new privacy features that are designed for your safety and put " +
                        "you in control, and more seamless ways to get right to your gameplay or even switch to a new device.",
                "October 4, 2021",
                "https://www.youtube.com/watch?v=IgeuXF60Ins"
            )
        )
    }
}
